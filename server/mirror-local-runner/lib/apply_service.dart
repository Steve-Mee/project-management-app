...
class MirrorApplyService extends Service {
  MirrorApplyService({required this.executor}) {
  ...
  // gRPC endpoint signature mirrors Compile: (ServiceCall, List<int>) -> Future<List<int>>.
  ...
  // HTTP endpoint keeps the same payload/response bytes signature as Compile.
