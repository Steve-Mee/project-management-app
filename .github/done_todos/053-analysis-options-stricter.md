...
- [x] DONE: Run flutter analyze and fix all new warnings

**Verification Notes:**
- Added `docs/analyzer-guidelines.md` with current analyzer command policy and rationale.
- Removed outdated `--no-fatal-infos` wording from TODO tracking.