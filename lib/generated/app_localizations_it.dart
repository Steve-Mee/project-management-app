...
class AppLocalizationsIt extends AppLocalizations {
  ...
  String get mirrorApplyRiskAcknowledgeTitle =>
      'Capisco il rischio dell\'applicazione diretta';

  @override
  String get mirrorApplyRiskAcknowledgeSubtitle =>
      'Le modifiche verranno applicate alla directory di lavoro. Si consiglia di usare un branch separato.';

  @override
  String get mirrorPermissionDenied =>
      'Mirror non è disponibile per il tuo account.';

  @override
  String get mirrorFeatureDisabled =>
      'Mirror è attualmente disabilitato dall\'amministratore.';

  @override
  String get mirrorPermissionRevokedSessionDisabled =>
      'La tua sessione dell\'editor Mirror è stata disattivata perché le tue autorizzazioni sono cambiate. Chiudi questa schermata per continuare in sicurezza.';

  @override
  String get mirrorPermissionRevokedTerminal =>
      'Accesso a Mirror revocato: sessione terminata.';

  @override
  String get mirrorApplyDiffPreview => 'Anteprima differenze';

  @override
  String get mirrorApplyNo => 'No';

  @override
  String get mirrorApplyConfirm => 'Applica';

  @override
  String get mirrorApplyNoDiff => '(Nessuna differenza rilevata)';

  @override
  String get mirrorApplyBranchAdviceTitle =>
      'Nome branch suggerito – solo consiglio';

  @override
  String mirrorApplyCurrentBranch(String branch) {
    return 'Branch attuale: $branch';
  }

  @override
  String mirrorApplySuggestedBranch(String branch) {
    return 'Nome branch suggerito (solo consiglio): $branch';
  }

  @override
  String get mirrorApplyBranchTip =>
      'Suggerimento: crea prima un nuovo branch per una revisione sicura e il rollback.';

  @override
  String mirrorApplyBranchTipWithBranch(String branch) {
    return 'Solo suggerimento: valuta il branch suggerito \"$branch\" come consiglio per una revisione piu sicura e un rollback piu semplice.';
  }
