...
class AppLocalizationsPt extends AppLocalizations {
  ...
  String get mirrorApplyRiskAcknowledgeTitle =>
      'Entendo o risco de aplicar diretamente';

  @override
  String get mirrorApplyRiskAcknowledgeSubtitle =>
      'As alterações serão aplicadas ao seu diretório de trabalho. Prefira usar um branch separado.';

  @override
  String get mirrorPermissionDenied =>
      'Mirror não está disponível para sua conta.';

  @override
  String get mirrorFeatureDisabled =>
      'Mirror está atualmente desativado pelo administrador.';

  @override
  String get mirrorPermissionRevokedSessionDisabled =>
      'Sua sessão do editor Mirror foi desativada porque sua permissão mudou. Feche esta tela para continuar com segurança.';

  @override
  String get mirrorPermissionRevokedTerminal =>
      'Acesso ao Mirror revogado: sessão encerrada.';

  @override
  String get mirrorApplyDiffPreview => 'Pré-visualização de diferenças';

  @override
  String get mirrorApplyNo => 'Não';

  @override
  String get mirrorApplyConfirm => 'Aplicar';

  @override
  String get mirrorApplyNoDiff => '(Nenhuma diferença detectada)';

  @override
  String get mirrorApplyBranchAdviceTitle =>
      'Nome do branch sugerido – apenas sugestão';

  @override
  String mirrorApplyCurrentBranch(String branch) {
    return 'Branch atual: $branch';
  }

  @override
  String mirrorApplySuggestedBranch(String branch) {
    return 'Nome do branch sugerido (apenas sugestão): $branch';
  }
  ...
  String mirrorApplyBranchTipWithBranch(String branch) {
    return 'Apenas sugestao: considere o branch sugerido \"$branch\" como orientacao para revisao mais segura e rollback mais simples.';
  }

  @override
  String get mirrorApplyBranchWorkingTreeNotice =>
      'Mirror aplica as alterações no seu diretório de trabalho atual e não cria nem muda de branch automaticamente.';
