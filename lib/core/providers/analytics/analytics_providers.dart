/// Analytics-related providers
/// Tracks usage, costs, and analytics data for the app.
/// Includes AI usage tracking, user analytics, and performance metrics.
/// See .github/issues/037-ai-usage-history.md for AI usage implementation.
/// See .github/issues/038-split-provider-files.md for provider organization.
library;
