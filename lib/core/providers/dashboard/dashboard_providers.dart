...
class DashboardConfigNotifier extends AsyncNotifier<List<DashboardItem>> {
  ...
  static final List<DashboardTemplate> _builtInPresets = [
    DashboardTemplate(
      ...
      items: const [
        const DashboardItem(widgetType: DashboardWidgetType.projectOverview, position: const {'x': 0, 'y': 0, 'width': 600, 'height': 400}),
        const DashboardItem(widgetType: DashboardWidgetType.taskList, position: const {'x': 600, 'y': 0, 'width': 600, 'height': 400}),
        const DashboardItem(widgetType: DashboardWidgetType.progressChart, position: const {'x': 0, 'y': 400, 'width': 600, 'height': 400}),
      ],
      isPreset: true,
    ...
    DashboardTemplate(
      ...
      items: [
        const DashboardItem(widgetType: DashboardWidgetType.taskList, position: {'x': 0, 'y': 0, 'width': 600, 'height': 400}),
        const DashboardItem(widgetType: DashboardWidgetType.kanbanBoard, position: {'x': 600, 'y': 0, 'width': 600, 'height': 400}),
        const DashboardItem(widgetType: DashboardWidgetType.calendar, position: {'x': 0, 'y': 400, 'width': 1200, 'height': 400}),
      ],
      isPreset: true,
      createdAt: DateTime(2023, 1, 1),
    ),
    DashboardTemplate(
      ...
      name: 'Analytics',
      items: [
        const DashboardItem(widgetType: DashboardWidgetType.metricCard, position: {'x': 0, 'y': 0, 'width': 400, 'height': 200}),
        const DashboardItem(widgetType: DashboardWidgetType.progressChart, position: {'x': 400, 'y': 0, 'width': 400, 'height': 400}),
        const DashboardItem(widgetType: DashboardWidgetType.timeline, position: {'x': 800, 'y': 0, 'width': 400, 'height': 400}),
        const DashboardItem(widgetType: DashboardWidgetType.projectOverview, position: {'x': 0, 'y': 400, 'width': 600, 'height': 400}),
      ],
      isPreset: true,
      createdAt: DateTime(2023, 1, 1),
    ),
    DashboardTemplate(
      ...
      name: 'Notifications',
      items: [
        const DashboardItem(widgetType: DashboardWidgetType.notificationFeed, position: {'x': 0, 'y': 0, 'width': 600, 'height': 400}),
        const DashboardItem(widgetType: DashboardWidgetType.calendar, position: {'x': 600, 'y': 0, 'width': 600, 'height': 400}),
        const DashboardItem(widgetType: DashboardWidgetType.projectOverview, position: {'x': 0, 'y': 400, 'width': 1200, 'height': 400}),
      ],
      isPreset: true,
      createdAt: DateTime(2023, 1, 1),
    ),
